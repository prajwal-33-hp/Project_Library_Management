...
BOOKS = [
    ...
    ("Dragonfly in Amber", "Diana Gabaldon", 5),
    ("Voyager", "Diana Gabaldon", 5),
    ("Me Before You", "Jojo Moyes", 7),
    ("After You", "Jojo Moyes", 6),
    ("Still Me", "Jojo Moyes", 5),
    ("The Fault in Our Stars", "John Green", 8),
    ("Looking for Alaska", "John Green", 7),
    ("Paper Towns", "John Green", 6),
    ("An Abundance of Katherines", "John Green", 5),
    ("Turtles All the Way Down", "John Green", 5),
    ("Eleanor & Park", "Rainbow Rowell", 6),
    ("Fangirl", "Rainbow Rowell", 5),
    ("Attachments", "Rainbow Rowell", 5),
    ("The Hating Game", "Sally Thorne", 6),
    ("It Ends with Us", "Colleen Hoover", 8),
...
def init_db():
    ...
    for attempt in range(1, max_attempts + 1):
        try:
            ...
            """)
            # Seed 500 sample books if the table is empty
            ...
            if book_count == 0:
                ...
                for title, author, quantity in BOOKS:
                    ...
                    inserted += 1
                print(f"Seeded {inserted} sample books into the database.")
