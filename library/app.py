...
def student_books():
    ...
    try:
        ...
        flash(f'Database error: {str(e)}')
        return render_template('books.html', books=[], query='', role='student')
...
def staff_dashboard():
    ...
    try:
        ...
        flash(f'Database error: {str(e)}')
        return render_template('staff_dashboard.html', user=session['user'], stats={'total': 0})
...
def staff_books():
    ...
    try:
        ...
        flash(f'Database error: {str(e)}')
        return render_template('books.html', books=[], query='', role='staff')
...
def edit_book(book_id):
    ...
    try:
        ...
        flash(f'Database error: {str(e)}')
        return render_template('add_book.html', book=None, edit=False)
